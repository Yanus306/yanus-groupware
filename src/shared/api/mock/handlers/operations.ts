...
let mockAttendanceExceptions: AttendanceException[] = [
  {
    ...
    endsNextDay: true,
    scheduledStartAt: `${today}T22:00:00`,
    scheduledEndAt: `${tomorrow}T06:00:00`,
    checkInTime: `${today}T22:02:00`,
    checkOutTime: null,
  },
  {
    id: 2,
    ...
    endsNextDay: false,
    scheduledStartAt: `${today}T09:00:00`,
    scheduledEndAt: `${today}T18:00:00`,
  ...
  },
  {
    ...
    scheduledEndTime: '18:00:00',
    endsNextDay: false,
    scheduledStartAt: `${today}T13:00:00`,
    scheduledEndAt: `${today}T18:00:00`,
    checkInTime: null,
    checkOutTime: null,
  },
    ...
    items: [
      {
        ...
        scheduledEndTime: '18:00:00',
        endsNextDay: false,
        scheduledStartAt: `${yearMonth}-${baseDay}T09:00:00`,
        scheduledEndAt: `${yearMonth}-${baseDay}T18:00:00`,
      ...
      },
      {
        ...
        scheduledEndTime: '06:00:00',
        endsNextDay: true,
        scheduledStartAt: `${yearMonth}-${String(Number(baseDay) + 3).padStart(2, '0')}T22:00:00`,
        scheduledEndAt: `${yearMonth}-${String(Number(baseDay) + 4).padStart(2, '0')}T06:00:00`,
        checkInTime: `${yearMonth}-${String(Number(baseDay) + 3).padStart(2, '0')}T22:08:00`,
        checkOutTime: `${yearMonth}-${String(Number(baseDay) + 4).padStart(2, '0')}T06:01:00`,
        lateMinutes: 8,
        fee: 800,
        status: 'LATE',
      },
      {
        ...
        scheduledEndTime: '18:00:00',
        endsNextDay: false,
        scheduledStartAt: `${yearMonth}-${String(Number(baseDay) + 6).padStart(2, '0')}T09:00:00`,
        scheduledEndAt: `${yearMonth}-${String(Number(baseDay) + 6).padStart(2, '0')}T18:00:00`,
